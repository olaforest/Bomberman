...
public class CollisionDetector {
	...
	public boolean checkExactCollision(Bomberman bomberman, GridObject b) {
		if((bomberman !=null) && (b != null))
			return (Math.abs(bomberman.xPosition - b.xPosition) < bomberman.MISALIGNMENT_ALLOWED && (bomberman.yPosition == b.yPosition)) || (Math.abs(bomberman.yPosition - b.yPosition) < bomberman.MISALIGNMENT_ALLOWED && (bomberman.xPosition == b.xPosition));	
